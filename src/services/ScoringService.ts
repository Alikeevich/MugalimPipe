...
return Добро пожаловать на урок математики. Сегодня мы изучаем квадратные уравнения.  Квадратное уравнение имеет вид ax² + bx + c = 0, где a не равно нулю.  Для решения квадратных уравнений мы можем использовать несколько методов.  Первый метод - это факторизация. Второй метод - использование квадратной формулы.  Давайте рассмотрим примеры. Возьмем уравнение x² - 5x + 6 = 0.  Мы можем разложить это на множители: (x - 2)(x - 3) = 0.  Следовательно, x = 2 или x = 3. Это наши решения.  Теперь попробуйте решить следующее уравнение самостоятельно.;
}
